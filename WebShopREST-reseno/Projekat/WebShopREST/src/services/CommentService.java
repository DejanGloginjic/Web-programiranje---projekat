...
public class CommentService {
	...
	public Comment newTraining(Comment comment) {
		CommentDAO dao = (CommentDAO) ctx.getAttribute("commentDAO");
	...
	@Path("/search")
	@Produces(MediaType.APPLICATION_JSON)
	public Comment search(@QueryParam("name") String name) {
		CommentDAO dao = (CommentDAO) ctx.getAttribute("commentDAO");
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Comment changeOne(Comment comment, @PathParam("id") int id) {
		CommentDAO dao = (CommentDAO) ctx.getAttribute("commentDAO");
